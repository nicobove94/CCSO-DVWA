...
function &dvwaPageNewGrab() {
	$returnArray = array(
		'title'           => 'Damn Vulnerable Web Application (DVWA) v' . dvwaVersionGet() . '(CCSO Edition)',
		'title_separator' => ' :: ',
		'body'            => '',
		'page_id'         => '',
		'help_button'     => '',
...
function dvwaHtmlEcho( $pPage ) {
	...
	if( dvwaIsLoggedIn() ) {
		...
		$menuBlocks[ 'home' ][] = array( 'id' => 'phpinfo', 'name' => 'PHP Info', 'url' => 'phpinfo.php' );
	...
	<body class=\"home\">
		<div id=\"container\">
			...
			<div id=\"footer\">
				...
				<p>Damn Vulnerable Web Application (DVWA) v" . dvwaVersionGet() . " (CCSO Edition)<br />Adapted by Nicolas Bove</p>
