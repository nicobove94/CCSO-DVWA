...
<div class=\"body_padded\">
	<h1>The CCSO DVWA</h1>
        <p>The Competitive Cyber Security Organization's Damn Vulnerable Web Application is a fork of digininja's Damn Vulnerable Web Application (" . dvwaExternalLinkUrlGet('https://github.com/digininja/DVWA', 'DVWA') . "). It is intended for the members of the Collegiate Penetration Testing Competition Team to practice implementing various attacks in a capture-the-flag environment.</p>
  ...
  <p><em>(The following text is from the original creators of the DVWA)</em></p>
        <h2>WARNING!</h2>
